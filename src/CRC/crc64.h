...
extern algorithm64  CRC64_ECMA_182,     ///< DLT-1 cartridges
 ...
 *      uint64_t crc1 = getCRC64(message1, &CRC64_ECMA_182, length1);
 *      uint64_t crc2 = getCRC64(message2, &CRC64_ECMA_182, length2);
 *  }
 *  @endcode
 */
